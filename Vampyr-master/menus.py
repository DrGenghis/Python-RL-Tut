...
def main_menu(con, background_image, screen_width, screen_height):
	...
	libtcod.console_print_ex(0, int(screen_width / 2), int(screen_height / 2) - 4, libtcod.BKGND_NONE, libtcod.CENTER, 'VAMPYR')
	libtcod.console_print_ex(0, int(screen_width / 2), int(screen_height / 2 - 2), libtcod.BKGND_NONE, libtcod.CENTER, 'By DrGenghis')
	
	menu(con, '', ['New Game', 'Continue', 'Exit'], 24, screen_width, screen_height)
